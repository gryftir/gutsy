...
sub option {
    ...
    if ($help) { help(); }
        ...
        $coderef = GutsyExample::get_subroutine( 1, $jobtype );
    }
    elsif ( $location ne "" ) {
        $coderef = GutsyExample::get_subroutine( 2, $location );
    }
    elsif ( $proglang ne "" ) {
        $coderef = GutsyExample::get_subroutine( 3, $proglang );
    }
    else {
